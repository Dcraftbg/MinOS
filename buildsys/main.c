...
#define CFLAGS "-g", "-nostdlib", "-march=x86-64", "-ffreestanding", "-static", "-Werror", "-Wno-unused-function", "-Wall", "-fomit-frame-pointer", "-fno-builtin", "-fno-stack-protector", "-mno-red-zone", "-mno-mmx", "-mno-sse", "-mno-sse2", "-mno-3dnow", "-fPIC"
